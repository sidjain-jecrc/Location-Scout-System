...
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <p>
            <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="http://webstrar14.fulton.asu.edu/page1/TryItWebForm.aspx" style="font-size: medium">Back To Required Services Try It Page</asp:HyperLink>
        </p>
    </form>
    <p class="auto-style1">
        &nbsp;</p>
