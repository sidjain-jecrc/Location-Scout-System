...
&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <p>
            <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="http://webstrar14.fulton.asu.edu/page1/ElectiveTryItWebForm.aspx" style="font-size: medium">Go To Elective Services TryIt Page</asp:HyperLink>
        </p>
    </form>
    <p>
        &nbsp;</p>
